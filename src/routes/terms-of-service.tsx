      ...
      <section className="section-pad">
        <div className="container-page mx-auto max-w-2xl space-y-8 text-sm leading-relaxed text-foreground">
          <p className="text-muted-foreground">
            ...
            {" "}{site.name}. By using this site or placing an order, you agree to these Terms.
          </p>

          <div>
            <h2 className="text-lg font-bold">1. Who we are</h2>
            <p className="mt-2 text-muted-foreground">
              {site.name} sells retail display and ESL (electronic shelf label) accessories to businesses and
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              To the extent permitted by Malaysian law, {site.name} is not liable for indirect or
          ...
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              <a href={`mailto:${site.email}`} className="font-semibold text-primary underline">{site.email}</a>{" "}
