...
const SCHEMAS: Record<CrudKey, { fields: Field[]; defaults: Record<string, unknown> }> = {
  products: {
    ...
    defaults: { name: "", slug: "", category: "", description: "", features: [], image_url: "", image_urls: [], price: 0, sku: "", stock: 0, is_purchasable: true, sort_order: 0, is_featured: false, is_active: true },
  },
  categories: {
    fields: [
      { key: "name", label: "Name", type: "text" },
