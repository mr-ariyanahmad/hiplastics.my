          ...
          >
            ...
            <div className="flex flex-wrap items-start justify-between gap-4 bg-gradient-to-r from-[var(--invoice-accent,var(--color-primary))]/5 to-transparent p-6">
              <div className="flex items-center gap-3">
                {settings.logo_url ? (
                  <img src={settings.logo_url} alt={site.name} className="h-14 w-14 shrink-0 rounded-lg border border-border/60 bg-white object-contain p-1.5" />
                ) : (
                ...
                <div>
                  <div className="text-xl font-extrabold leading-tight text-[var(--invoice-accent,var(--color-primary))]">{site.name}</div>
                  <div className="text-xs text-muted-foreground">{site.address}</div>
                  <div className="text-xs text-muted-foreground">{site.email} · {site.phone}</div>
                </div>
              </div>
            ...
            <div className="p-6">
              <div className="grid gap-4 border-b border-border pb-4 text-sm sm:grid-cols-2">
                <div>
                  ...
                  <div className="mt-1 font-semibold text-foreground">{site.name}</div>
                  <div className="text-muted-foreground">{site.address}</div>
                  <div className="text-muted-foreground">{site.email} · {site.phone}</div>
                </div>
